...
5. ห้ามใส่การอ้างอิงข้อมูลเช่น [1] หรือ [^1^] ในคำตอบเด็ดขาด ยกเว้นแต่ผู้ใช้จะร้องขออย่างชัดเจนว่าต้องการแหล่งอ้างอิง
...
- ห้ามใส่การอ้างอิงข้อมูลเช่น [1] หรือ [^1^] ในคำตอบเด็ดขาด ยกเว้นผู้ใช้จะร้องขออย่างชัดเจน
...
- อ้างอิงแหล่งที่มาน่าเชื่อถือ (UN, World Bank, สภาพัฒน์, BOT, กระทรวง) แต่ห้ามใส่ลิงก์อ้างอิงแบบ [1] หรือ [^1^] แทรกในเนื้อหาเด็ดขาด ยกเว้นผู้ใช้จะสั่ง
